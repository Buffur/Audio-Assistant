...
CATALOG_DOCUMENT_ALREADY_OPEN_TEXT = (
    "Цей документ уже відкритий. "
    "Користуйтеся кнопками під останнім аудіо або натисніть «Зупинити читання», "
    "щоб відкрити його заново."
)
CATALOG_OPEN_BUSY_TEXT = (
    "Попередній документ ще очікує або генерується. "
    "Дочекайтесь аудіо або натисніть «Зупинити читання» перед відкриттям іншого."
)
