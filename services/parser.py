...
5. Не перекладай знайдений текст, збережи його оригінальну мову.
6. Не використовуй Markdown.
7. Якщо текст не схожий на статтю або новину, все одно спробуй повернути
...
Автоматично визнач мову вхідного тексту і відповідай тією самою мовою.
