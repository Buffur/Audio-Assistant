...
class Settings(BaseSettings):
    ...
    OCR_IMAGE_OPEN_TIMEOUT_SECONDS: int = 15
    OCR_TOTAL_TIMEOUT_SECONDS: int = 150
    TELEGRAM_FILE_DOWNLOAD_TIMEOUT_SECONDS: int = 60
    PDF_EXTRACTION_TIMEOUT_SECONDS: int = 60
    DOCX_EXTRACTION_TIMEOUT_SECONDS: int = 45
    TXT_EXTRACTION_TIMEOUT_SECONDS: int = 15
    ...
    READING_AUDIO_QUEUE_WORKER_COUNT: int = 2
    EXPORT_AUDIO_MAX_SIZE_MB: int = 48
    EXPORT_AUDIO_SMOOTH_MERGE_ENABLED: bool = False
    EXPORT_AUDIO_CROSSFADE_MS: int = 120
    EXPORT_AUDIO_CONCAT_TIMEOUT_SECONDS: int = 300
    ...
    @field_validator(
        ...
        "EXPORT_AUDIO_CONCAT_TIMEOUT_SECONDS",
...
OCR_IMAGE_OPEN_TIMEOUT_SECONDS = settings.OCR_IMAGE_OPEN_TIMEOUT_SECONDS
OCR_TOTAL_TIMEOUT_SECONDS = settings.OCR_TOTAL_TIMEOUT_SECONDS
TELEGRAM_FILE_DOWNLOAD_TIMEOUT_SECONDS = (
    settings.TELEGRAM_FILE_DOWNLOAD_TIMEOUT_SECONDS
)
PDF_EXTRACTION_TIMEOUT_SECONDS = settings.PDF_EXTRACTION_TIMEOUT_SECONDS
DOCX_EXTRACTION_TIMEOUT_SECONDS = settings.DOCX_EXTRACTION_TIMEOUT_SECONDS
TXT_EXTRACTION_TIMEOUT_SECONDS = settings.TXT_EXTRACTION_TIMEOUT_SECONDS
...
READING_AUDIO_QUEUE_WORKER_COUNT = settings.READING_AUDIO_QUEUE_WORKER_COUNT
...
EXPORT_AUDIO_CONCAT_TIMEOUT_SECONDS = settings.EXPORT_AUDIO_CONCAT_TIMEOUT_SECONDS
